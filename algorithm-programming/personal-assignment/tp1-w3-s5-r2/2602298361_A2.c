 ...
 *  Saat menggunakan function scanf_s saya memasukan dua buah argumen yaitu formattingnya
 *  dan tujuan alamat variable untuk menyimpan string hasil dari inputan menggunakan simbol `&`.
 *  Dalam contoh ini scanf_s membutuhkan address dari variable name untuk dimasukan string dari inputan.
 *  scanf_s akan memasukan value ke dalam memory sesuai dengan alamat yang kita berikan.
